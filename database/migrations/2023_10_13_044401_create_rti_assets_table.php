...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('rti_assets', function (Blueprint $table) {
        ...
        Schema::create('rti_assets_details', function (Blueprint $table) {
            $table->uuid('uid')->primary();
            $table->uuid('rti_assets_id')->nullable(false);
            //$table->foreignUuid('rti_assets_id')->references('uid')->on('rti_assets')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('rti_assets');
    }
};
