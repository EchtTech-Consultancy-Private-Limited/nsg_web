<div class="row align-items-center">
    ...
    <div class="col-sm-4 col-lg-12 col-xl-8 width-sm-mobile-right">
        <div class="header-top-right">
            <div class="content ">
                <ul>
                    <li class="d-none d-xl-block"><a href="{{ route('sitemap') }}" title="@if(Session::get('locale') == 'hi')
                            {{ config('staticTextLang.Sitemap_hi') }} @else {{ config('staticTextLang.Sitemap_en') }}
                            @endif">@if(Session::get('locale') == 'hi')
                            {{ config('staticTextLang.Sitemap_hi') }} @else {{ config('staticTextLang.Sitemap_en') }}
                            @endif</a></li>
                    <li class="d-none d-xl-block"><a href="{{ route('feedback') }}" title="@if(Session::get('locale') == 'hi')
                            {{ config('staticTextLang.Feedback_hi') }} @else {{ config('staticTextLang.Feedback_en') }}
                            @endif">@if(Session::get('locale') == 'hi')
                            {{ config('staticTextLang.Feedback_hi') }} @else {{ config('staticTextLang.Feedback_en') }}
                            @endif</a></li>
                    <li class="d-none d-xl-block"><a href="{{ route('screen-reader-access') }}" title="@if(Session::get('locale') == 'hi') {{ config('staticTextLang.sra_hi') }} @else
                    ...
                    <li class="d-none d-xl-block"><a href="#main_content" title="@if(Session::get('locale') == 'hi') {{ config('staticTextLang.stmc_hi') }} @else
